 ...
 *
 */
class CommandLineInterfaceCmd extends CmdLineHandler
{
    ...
    public static $action_class = '\\Froxlor\\Cli\\Action\\CommandLineInterfaceAction';
    ...
    public static function printHelp()
    {
        ...
        self::println("");
        // commands
        self::println("--list-domains\t\tLists all domains");
        self::println("");
        /*
